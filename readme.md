...
[src](https://github.com/alejandro-ao/chat-with-websites)
...
This is more clearly explained in the
```


[Youtube video tutorial](https://youtu.be/bupx08ZgSFg), but here is a diagram that shows the process:
